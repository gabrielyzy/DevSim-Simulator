...
$('body').on('click', '.share', () => {
    twShare(`https://github.com/gabrielyzy`, `Eu consegui ${developer.followers.toLocaleString()} compradores no DevSim Simulator Game by @unabletolife.`, 520, 350);
    return false;
});
...
const penNames = [
    ...
    'Software de Automação de Marketing Baseado em IA',
    'Aplicativo de Realidade Aumentada para Treinamento Corporativo',
    'Sistema de Gestão de Projetos com IA',
    'Plataforma de Comércio Eletrônico',
    'Software de Segurança Cibernética',
    'Monitoramento de Qualidade de Produção',
    'Colaboração Remota com Recursos Avançados de VR',
    'Análise de Sentimentos em Redes Sociais',
    'Software de Gestão de Saúde e Bem-Estar Corporativo',
    'Reconhecimento Facial para Segurança de Acesso',
    'Aplicativo de Finanças Pessoais com Planejamento Automático',
    'Plataforma de Atendimento ao Cliente com Chatbots Avançados',
    'Gestão de Recursos Humanos com IA',
]

const research = [
    {
        'index': 1,
        'name': 'Aprenda HTML básico',
        'cost': 10,
        'increaseCss': 0,
        'increaseJs': 0,
        'increaseHtml': 10,
        ...
        'index': 12,
        'name': 'Leia artigos sobre truques de CSS',
        'cost': 1150,
        'increaseCss': 20,
        'increaseJs': 0,
        'increaseHtml': 0,
    ...
    {
        'index': 15,
        'name': 'Assista tutoriais no youtube',
        'cost': 2200,
        'increaseCss': 10,
        'increaseJs': 10,
        'increaseHtml': 10,
        ...
        'index': 24,
        'name': 'Experimente a tecnologia mais recente',
        'cost': 9000,
        'increaseCss': 20,
        'increaseJs': 20,
        'increaseHtml': 20,
        ...
        'index': 26,
        'name': 'Faça uma aula magistral de CSS',
        'cost': 12000,
        'increaseCss': 60,
        'increaseJs': 0,
        'increaseHtml': 0,
        ...
        'index': 27,
        'name': 'Faça uma aula magistral de JS',
        'cost': 13000,
        'increaseCss': 0,
        'increaseJs': 60,
        'increaseHtml': 0,
        ...
        'index': 28,
        'name': 'Faça uma master class DESIGN',
        'cost': 14000,
        'increaseCss': 0,
        'increaseJs': 0,
        'increaseHtml': 0,
        ...
        'index': 29,
        'name': 'Faça algum projeto bastante lucrativo',
        'cost': 15000,
        'increaseCss': 30,
        'increaseJs': 30,
        'increaseHtml': 30,
...
function keyPress() {
    if (progress > 0) {
        $('.startMashing h2 span').html("é isso, continue")
    }

    if (progress > 20) {
        $('.startMashing h2 span').html("Agora estamos chegando a algum lugar")
    }

    if (progress > 40) {
        $('.startMashing h2 span').html("elimine esses bugs")
    }

    if (progress > 70) {
        $('.startMashing h2 span').html("Quase terminado")
    }

    if (progress > 99) {
        $('.startMashing h2 span').html("feito!")
    }
